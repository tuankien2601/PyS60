...
class PrototypePreamble(StaticVisitor):
    CODE = """/* The macros defined below have very generic names and this can pollute
 * the namespace when included. Define PYTHON_AST_NO_MACRO macro to disable 
 * these macro definitions. */
#ifndef PYTHON_AST_NO_MACRO"""

class PrototypePostamble(StaticVisitor):
    CODE = "#endif // PYTHON_AST_NO_MACRO"
