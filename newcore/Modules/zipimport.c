...
/* Cleanup global objects which are not released implicitly in Py_Finalize. 
 * This method is called from Py_Finalize */
void PyZipImport_Fini(void)
{
	Py_XDECREF(zip_directory_cache);
}
