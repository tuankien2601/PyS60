...
class CoercionTest(unittest.TestCase):
    ...
    def test_infinite_rec_classic_classes(self):
        ...
        try:
            ...
            return
        # Infinite recursion on platforms like Symbian which have limited stack
        # in the order of few kB will cause the stack to overflow much 
        # before the default recursion limit of 1000 is hit resulting in 
        # MemoryError and not RuntimeError exception.
        except MemoryError:
